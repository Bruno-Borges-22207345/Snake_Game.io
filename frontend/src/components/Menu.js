                        ...
                        visible ?
                            <div className="main">
                                <div className="usernamecontainer">
                                    <p className="username"> <img className="snakeimg" src={require("./image.png")} width="130" height="130" /> HELLO, User! </p>
                                ...
                                <div className="scores">
                                    ...
                                    <p>Your latest scores are <br></br>{ scores !== undefined ? scores.map(e => e.score).join(', ') : 0 }!</p>
                                </div>
                            </div>
                            : ""
                    }
